                                ...
                                <b-table :items="records" :fields="fields" :current-page="currentPage"
                                    ...
                                    <template #cell(actions)="row">
                                        <router-link
                                            ...
                                            class="btn btn-primary btn-sm" v-if="$can('seller_update')"
                                        ...
                                        }" v-b-tooltip.hover title="Products" class="btn btn-info btn-sm"
                                            v-if="$can('seller_update')" v-b-tooltip.hover:title="__('Products')">
                                            <i class="fa fa-pencil-alt"></i>
                                        </router-link>
